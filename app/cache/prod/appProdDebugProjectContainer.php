...
class appProdDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['propel.configuration'] = new \PropelConfiguration(array('datasources' => array('default' => array('adapter' => 'mysql', 'connection' => array('dsn' => 'mysql:host=127.0.0.1;dbname=cms;charset=UTF8', 'user' => 'root', 'classname' => 'DebugPDO', 'options' => array(), 'attributes' => array(), 'settings' => array(), 'model_paths' => array(0 => 'src/', 1 => 'vendor/'))))));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58537e58d2cf19.20640555')), true);
